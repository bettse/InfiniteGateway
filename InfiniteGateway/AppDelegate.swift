...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    lazy var toyboxDirectory : URL  = {
        let toyboxName = "Toybox"
        let fileManager = FileManager.default
        let url = self.applicationDocumentsDirectory.appendingPathComponent(toyboxName)
        do {
    ...
    lazy var applicationDocumentsDirectory: URL = {
        ...
        return appSupportURL.appendingPathComponent(bundleId!)
    }()

    lazy var managedObjectModel: NSManagedObjectModel = {
        // The managed object model for the application. This property is not optional. It is a fatal error for the application not to be able to find and load its model.
        let modelURL = Bundle.main.url(forResource: "InfiniteGateway", withExtension: "momd")!
